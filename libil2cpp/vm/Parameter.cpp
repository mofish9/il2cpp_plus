...
namespace vm
{
    Il2CppObject* Parameter::GetDefaultParameterValueObject(const MethodInfo* method, int32_t parameterPosition, bool* isExplicitySetNullDefaultValue)
    {
        ...
        const Il2CppImage* metadataImage = hybridclr::metadata::MetadataModule::GetDheMethodMetadataImage(method);
        if (il2cpp::vm::Class::IsValuetype(parameterType))
        {
            ...
            utils::BlobReader::GetConstantValueFromBlob(metadataImage, typeOfDefaultValue->type, data, value);
